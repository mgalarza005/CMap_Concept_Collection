...
c=d.cloneNode(!0):(d=$.ik(e.body),d.data(this.data()),c=d.fa()):(d=$.ik(e.body),d.data(this.data())),d=$.kg(),f=c,d.gc(f,"width","100%"),d.gc(f,"height","50vw"),d.gc(f,"viewBox","0 0 "+this.width()+" "+this.height()),$.uf(f,"width","100%"),$.uf(f,"height",""),$.uf(f,"max-height","100%"),e.body.appendChild(c);$fa()};
