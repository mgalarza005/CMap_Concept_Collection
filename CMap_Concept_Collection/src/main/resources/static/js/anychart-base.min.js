...
$.g.Fd=function(){var a=nl(this);a&&$.n(this.ya)&&!this.ya&&this.B(gl,!1);this.ya=a;if(this.ef()||this.fd||!this.f||this.f.ff())return this;if(!this.enabled()&&(this.N||a))return this.J(gl)&&($.Xe(this.Jd),this.I(gl)),this;if(!mE){var b="",c=$.Ne("STYLE");
c.styleSheet?c.styleSheet.cssText=b:c.appendChild(window.document.createTextNode(String(b)));$.We($.Be(window.document,"head",void 0,void 0)[0],c,0);mE=!0}this.Jd||(this.Jd=$.Ne("DIV","anychart-credits"));this.g||(this.g=$.Ne("A"),this.D=$.Ne("SPAN","anychart-credits-text"),Ue(this.g,this.D),this.Jd.appendChild(this.g));b=this.f.Bl();this.J(gl)&&(b&&b.appendChild(this.Jd),this.I(gl));this.J(hl)&&(b=$.hc.apply(null,[", v%s.%s.%s.%s"].concat(["8","9","0","1932"])),
c=a?this.AJ():"AnyChart - JavaScript Charts designed to be embedded and integrated{{anychart-version}}",$.De(this.g,{title:c.replace("{{anychart-version}}",b)}),$.De(this.b,),this.I(hl));this.J(il)&&(a=a?this.text():"",$.ef(this.D,a),this.I(il));if(this.J(jl)){if(a=nl(this)?this.WE():ll()){if(this.O=a,b=uh($.kg()))$.Id(b,"complete",this.O2,!1,this),$.Id(b,
...
$.g.P=function(a){if($.n(a)&&this.Kc!=a)if(null===a)this.remove();else return this.Kc=a,a=this.Ta(),this.Kc.appendChild(a),this;return this.Kc};$.g.remove=function(){this.b&&($.Xe(this.b),this.Kc=null)};$.g.R=function(){this.remove();this.b=this.j=this.f=this.g=this.gb=null;Vv.u.R.call(this)};$.H(Zv,$.od);var Rda={position:"absolute","z-index":9999,left:0,top:0,width:"100%",height:"100%","pointer-events":"none"},HF={position:"relative",left:0,top:0,overflow:"hidden",width:"100%",height:"45vw"},Sda={position:"relative",left:0,top:0,width:"100%",height:"45vw", opacity:1,"pointer-events":"none"};$.g=Zv.prototype;$.g.AZ=function(){$.uf(this.pr,Rda);$.uf(this.b.Bl(),HF);$.uf(this.b.fa(),Sda)};
